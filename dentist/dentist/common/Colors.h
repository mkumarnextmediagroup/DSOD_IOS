...
@property(class, nonatomic, readonly) UIColor *strokes;
...
@property(class, nonatomic, readonly) UIColor *lineColorNor;
@property(class, nonatomic, readonly) UIColor *textColor9c;
@end
